...
class ChildTest < ActiveSupport::TestCase
  ...
  context "Creating a child context" do
    ...
    should "have name methods that list first_ and last_names combined" do
      ...
      assert_not_equal "alex Heinmann", @alex.name
    end
    ...
    should "have points earned method in order to show number of points a child has" do
      assert_equal 4, @alex.points_earned
      assert_not_equal 1, @alex.points_earned
